...
from ainemo.config.config_loader import ConfigLoader
from ainemo.providers.model_types import ModelType
from ainemo._legacy.translation_service import TranslationService
from ainemo._legacy.translation_request import TranslationRequest
from ainemo.utils.analyze_last_commit import FileChanges, get_git_commit_diff
...
def save_translations(git_diff: FileChanges, tanslation_request: TranslationRequest, repo_path: str):
    for lang in tanslation_request.get_to_languages():
        ...
        for file, modifications in git_diff.items():
            ...
            logger.info("Updated translations saved to %s", target_path) 
